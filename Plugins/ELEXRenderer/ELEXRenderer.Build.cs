...
public class ELEXRenderer : ModuleRules
{
	public Renderer(ReadOnlyTargetRules Target) : base(Target)
	{
		PrivateIncludePaths.AddRange(
			new string[] {
				"Runtime/ELEXRenderer/Private",
				"Runtime/ELEXRenderer/Private/CompositionLighting",
				"Runtime/ELEXRenderer/Private/PostProcess",
				"../Shaders/Shared"
				}
			);
